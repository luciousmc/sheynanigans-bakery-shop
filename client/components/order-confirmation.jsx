...
const OrderConfirmation = ({ setView, customer, orderItems, total }) => {
  ...
  return (
    <section className="container rounded order-confirm-container">
      ...
      <div className="row confirm-subtext">
        <div className="col-12">
          <p className="text-center text-danger">This is a demo site so no order will be processed </p>
        </div>
      </div>

      <div className="row order-number mt-3 mt-sm-5">
        <div className="col">
          <h2>Order: #{ customer.orderId }</h2>
        </div>
      </div>

      <div className="row product-details mt-3 mt-sm-5">
        <div className="col">
          <h3>Order Details</h3>
        </div>
      </div>
      ...
      <div className="row customer-details mt-5">
        <div className="col">
          <h3 className="text-center text-sm-left">Customer Details</h3>
        </div>
      </div>
